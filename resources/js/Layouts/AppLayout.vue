            ...
            <nav>
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link v-for="(navItem, index) in navItems" :href="route(navItem.routeName)"
                                              :active="route().current(navItem.routeName)">
                                    {{ navItem.name }}
                                </jet-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <jet-responsive-nav-link v-for="(navItem, index) in navItems" :href="route(navItem.routeName)"
                                                 :active="route().current(navItem.routeName)">
                            {{ navItem.name }}
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="flex items-center px-4">
                            ...
                            <div>
                                <div class="font-medium text-base text-gray-800" v-html="$page.props.user.name"/>
                                <div class="font-medium text-sm text-gray-500" v-html="$page.props.user.username"/>
                            </div>
                        </div>
